...
export const english: Record<string, string> = {
  ...
  先别继续: "Wait a moment",
  "先别继续（H）": "Wait a moment (H)",
  停下回答: "Stop the answer",
  "停下回答（Esc）": "Stop the answer (Esc)",
  "继续听（R）": "Keep listening (R)",
  "回答已停下，准备好了再继续听":
    "Answer stopped. Keep listening when you’re ready",
  在听你说: "Listening to you",
  没当成提问: "Not taken as a question",
  点这里问: "Ask it",
  "这次免费语音对话到时间了，节目会继续播放。":
    "This free voice session has ended. The podcast keeps playing.",
  再开一段语音: "Start voice again",
  "语音断了，正在重新连接…": "Voice dropped. Reconnecting…",
